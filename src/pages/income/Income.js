...
import { IoCashOutline, IoLogoUsd, IoBookmarkOutline, IoEllipsisHorizontalOutline } from 'react-icons/io5';
...
const IncomeCategory = forwardRef(({ category, category_total }, ref) => {
  ...
  return (
    <div className='my-3'>
      ...
      <div className='common-card p-2 px-md-4 bg1'>
...
const BalancePreviewComponent = forwardRef(({ balance, classname }, ref) => {

  return (
    <div className={`col-md-4 my-2`}>
      <div ref={ref} className={`common-card-1 p-2 p-md-3 bal-prev ${classname}`}>
    ...
    <div ref={ref}>
      <PageHolder>
        ...
        <PageBody>
          ...
          <div className="common-card-1 p-2 my-3">
            <div className="row">
          ...
          <div className="my-3 common-card1">
